...
func (p *DeleteNoteRequest) GetUserId() int64 {
	return p.UserId
}
...
func (p *DeleteNoteResponse) GetBaseResp() *BaseResp {
	if !p.IsSetBaseResp() {
...
func (p *NoteServiceDeleteNoteArgs) GetReq() *DeleteNoteRequest {
	if !p.IsSetReq() {
...
func (p *NoteServiceDeleteNoteResult) GetSuccess() *DeleteNoteResponse {
	if !p.IsSetSuccess() {
