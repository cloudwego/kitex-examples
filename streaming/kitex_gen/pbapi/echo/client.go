...
func (p *kEchoStreamClient) StreamRequestEcho(ctx context.Context, callOptions ...streamcall.Option) (stream Echo_StreamRequestEchoClient, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, streamcall.GetCallOptions(callOptions))
	return p.kClient.StreamRequestEcho(ctx)
}

func (p *kEchoStreamClient) StreamResponseEcho(ctx context.Context, Req *pbapi.Request, callOptions ...streamcall.Option) (stream Echo_StreamResponseEchoClient, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, streamcall.GetCallOptions(callOptions))
	return p.kClient.StreamResponseEcho(ctx, Req)
}

func (p *kEchoStreamClient) BidirectionalEcho(ctx context.Context, callOptions ...streamcall.Option) (stream Echo_BidirectionalEchoClient, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, streamcall.GetCallOptions(callOptions))
	return p.kClient.BidirectionalEcho(ctx)
}
